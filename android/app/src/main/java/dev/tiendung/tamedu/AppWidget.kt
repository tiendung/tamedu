...
val seletedPhaps = arrayOf("Tinh-Tan-fix", "Tran-Trong", "Vo-Mong", "Tu-Tap-Khong-Phai-Chi-La-Thien", 
    ...
    "thuyetphap-chilacamgiac", "thuyetphap_CacMucDoCoY", "thuyetphap_DucTin", "thuyetphap_giaTriGiaTang",
    "thuyetphap_songTichCuc", "tutaptrongCS_BuonChan", "tutaptrongCS_ChetKhongHoiTiec",
