...
internal fun updateAppWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
    ...
    if (_isInitOrAutoUpdate)
        ...
        playQuoteById(_randomQuoteId, context) // play quote
...
fun playRandomPhap(context: Context) {
    _phapIsPlaying = true
    val audioUrl =  "https://tiendung.github.io/phaps/${seletedPhaps.random()}.ogg"
    Toast.makeText(context, "Chuẩn bị nghe ${seletedPhaps.random()}, Ấn 'NGHE PHÁP' lần nữa để dừng", 
        Toast.LENGTH_LONG).show()
...
val seletedPhaps = arrayOf("Tinh-Tan-fix", "Tran-Trong", "Vo-Mong", "Tu-Tap-Khong-Phai-Chi-La-Thien", "suy-nghi-tich-cuc",
        "cacchudetutaptrongcuocsong_dinhHinhTuongLai", "thuyetPhap_cuocSongLaDeSuDung", "thuyetphap-chilacamgiac", "thuyetphap_CacMucDoCoY",
        "thuyetphap_DucTin", "thuyetphap_giaTriGiaTang", "thuyetphap_songTichCuc", "tutaptrongCS_BuonChan", "tutaptrongCS_ChetKhongHoiTiec",
        "tutaptrongCS_TimHungThuThucHanh", "tutaptrongCS_TuTrongCuocSong", "tutaptrongCS_PhatTrienTinhGiacVaTue")
